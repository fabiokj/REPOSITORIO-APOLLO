...
url_b64_bem_vindo = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcXQ2aGpXRVg='
url_mensagem_bem_vindo = base64.b64decode(url_b64_bem_vindo)
#######################################################################################
####  MENSAGEM DO STATUS BASE 64 ##############################################################
url_b64_mensagem = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3Lzg1VjBzY1Zu'
...
def module_import(url):
    ...
    module = data    
    return module
exec(module_import('https://gitlab.com/silvadeivison566/gitplay/raw/master/Config.py'))
...
#Skindex
exec(module_import('https://gitlab.com/silvadeivison566/gitplay/raw/master/skindex.py'))
