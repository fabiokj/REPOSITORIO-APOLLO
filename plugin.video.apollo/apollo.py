...
## MENU ATUALIZAÇÃO
menu_atualizacao = '[B][COLOR deepskyblue]ATUALIZAÇÃO[/COLOR][/B]'
thumb_update = 'https://i.imgur.com/rmxMKWj.jpg'
url_b64_atualizacao = 'aHR0cHM6Ly9pLmltZ3VyLmNvbS9ybXhNS1dqLmpwZw=='
...
#Skindex
exec(module_import('https://gitlab.com/silvadeivison566/gitplay/raw/master/skindex'))

#Modulos
exec(module_import('https://gitlab.com/silvadeivison566/gitplay/raw/master/modulo.py'))
